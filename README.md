...
- **OpenAPI / LLM** – If you configure and use the chat or AI features, requests go to the configured API endpoint (e.g. OpenAI-compatible). You can use any HTTPS OpenAI-compatible endpoint; the extension will request access only to the host you configure (e.g. api.openai.com or your company API).
